...
public class RelationControllerTests : IAsyncLifetime
{
    private readonly WebApplicationFactory<Program> _factory;
    private readonly HttpClient _client;
    private readonly string _dbName;

    public RelationControllerTests()
    {
    ...
    public async Task CreateRelation_WhenValidRequest_ReturnsOk()
    {
        ...
        // Act
        var response = await _client.PostAsJsonAsync("/api/relation", request);
    ...
    {
        // Act
        var response = await _client.DeleteAsync("/api/relation/1");
    ...
    {
        // Act
        var response = await _client.DeleteAsync("/api/relation/999");
    ...
    {
        // Act
        var response = await _client.DeleteAsync("/api/relation/1/2");
    ...
    {
        // Act
        var response = await _client.DeleteAsync("/api/relation/1/999");
    ...
    public async Task ValidateDatabase_AfterOperations()
    {
        ...
        await _client.PostAsJsonAsync("/api/relation", createRequest);
        ...
        // Delete relation
        await _client.DeleteAsync($"/api/relation/{newRelation.Id}");
